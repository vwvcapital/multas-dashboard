...
function IndicacaoDropdown({ multa, onIndicar, onRecusarIndicacao, onDesfazerIndicacao, iconSize = 'h-3.5 w-3.5', labelClass = 'hidden sm:inline' }: {
  multa: Multa
