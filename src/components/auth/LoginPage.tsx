...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 dark:from-black dark:via-black dark:to-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md relative bg-white/95 backdrop-blur-xl shadow-2xl border-0 dark:bg-neutral-950/95">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl font-bold bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent dark:from-neutral-100 dark:to-neutral-300">
            Comelli Transportes
          </CardTitle>
        ...
        <CardContent className="pt-4">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-700 dark:text-neutral-300">Usuário</label>
              <div className="relative">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-700 dark:text-neutral-300">Senha</label>
              <div className="relative">
